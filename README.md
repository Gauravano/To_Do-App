# Task Manager(a.k.a ToDo Application)

This app can be used to manage tasks of single/multiple user. A user just need to sign up via its E-mail ID and then he/she can easily add new tasks to the list. 
After registration, one can also see the tasks of his teammates, and after completing a task, `complete` button which is present right to each task can be clicked and that task would get added to the list of completed tasks. There is also an option to sign-out and clear all tasks at the bottom. 

## Database Used:
Firebase is used for storing the User Information and all the other data like tasks,etc.

## Technology Stack: 
React and Redux

## Progressive Web App Features:
1. Option of "Add to Homescreen"
2. Data caching
